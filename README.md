...
- This was a quick project that was made for fun, so if you want to see further updates, star the repo & create an "issue" [here](https://github.com/PowerMaybe/Discord-Email-Verify-Token-Gen/issues/new/choose)
